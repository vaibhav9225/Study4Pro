...
<div class="container"><br>
	<legend>Take Mock Test <span class="pull-right btn btn-small" id="timer">60 Minutes Remaining</span></legend>
	<div class="row">
		<div class="span11">
			<ol>
				<?php
				$courseId = $form->getGet('courseId');
				$ids = $questions->getTestQuestions($courseId,'id');
				$count=0;
				foreach($ids as $id){
					$count++;
			...
			<a href="test.php?courseId=<?php echo $courseId; ?>" class="btn">Take another test</a>
			<br/>
			<br/>
		</div>
	</div>
...
<div class="modal hide fade" id="resultModal">
	...
	<div class="modal-footer">
		<a href="test.php?courseId=<?php echo $courseId; ?>" class="btn">Take anoher test</a>
