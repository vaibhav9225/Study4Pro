...
<?php
$form->checkGet('key') ? 
	$database->checkValue('notes','filename',$form->getGet('key')) ?
		null
		: $page->kill('Chapter Wise Notes','Notes not found.')
	: $page->kill('Chapter Wise Notes','Notes not found.');
?>
<?php
...
$form->checkGet('chapterNo') ? 
	...
	: $page->kill('Chapter Wise Notes','Notes not found.');
?>
<?php $key = $form->getGet('key'); ?>
<?php $courseId = $form->getGet('courseId'); ?>
<?php $chapterNo = $form->getGet('chapterNo'); ?>
<!DOCTYPE html>
<html dir="ltr">
	<head>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
		<link rel="stylesheet" href="../pdfClasses/libs/viewer.css"/>
		<script type="text/javascript" src="../pdfClasses/libs/compatibility.js"></script>
		<script type="text/javascript" src="../pdfClasses/libs/booster.js"></script>
		<script type="text/javascript" src="../pdfClasses/libs/pdf.js"></script>
		<script type="text/javascript" src="../pdfClasses/libs/debugger.js"></script>
		<script type="text/javascript">
			'use strict';
			var DEFAULT_URL = './admin/uploads/<?php echo $key; ?>.pdf';
			PDFJS.workerSrc = 'pdf.js';
		</script>
		<script type="text/javascript" src="../pdfClasses/libs/viewer.js"></script>
					...
					<div id="toolbarContainer">
						<div id="toolbarViewer">
							<div id="toolbarViewerLeft">
								...
								<input type="number" id="pageNumber" class="toolbarField pageNumber" value="1" size="4" min="1" tabindex="7"></input>
							...
							<div id="toolbarViewerRight">
								...
								<button id="openFile" class="toolbarButton openFile hideBox" title="Open File" tabindex="12" data-l10n-id="open_file">
									<span data-l10n-id="open_file_label">Open</span>
								</button>
								<button id="print" class="toolbarButton print hideBox" title="Print" tabindex="13" data-l10n-id="print">
									<span data-l10n-id="print_label">Print</span>
								</button>
								<button id="download" class="toolbarButton download hideBox" title="Download" tabindex="14" data-l10n-id="download">
								...
								<?php echo "<a href='notes.php?courseId=$courseId&chapterNo=$chapterNo' class='toolbarButton' id='backLink'>Back to Study4Pro.com</a>"; ?>
							</div>
